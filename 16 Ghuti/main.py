import pygame,sys
from SholoGhuti.constants import WIDTH, HEIGHT, SQUARE_SIZE, RED, BLACK, BLUE,BG, MNU
      ...
      while True:
         ...
         if game.winner() != None:
            while True:
               ...
               run = False
               backbutton = Button(pos=(338, 550),text_input="BACK", font=get_font(), base_color="black", hovering_color="red")
   ...
   def main_menu():
      ...
      while True:
         ...
         QUIT_BUTTON = Button(pos=(338, 550), 
                           text_input="QUIT", font=pygame.font.SysFont('Calibri',40, pygame.font.Font.bold), base_color="black", hovering_color="red")
